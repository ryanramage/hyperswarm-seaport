...
Get.prototype.get = async function (meta) {
  ...
  await this.localRegistry.query(meta) // this is for the first time, can block a while
  // call to this.localRegistry.get(meta) will be fast, non blocking because of query
